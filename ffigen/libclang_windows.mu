...
CXVirtualFileOverlay struct #RefType {
	unused int
}
clang_VirtualFileOverlay_create(options uint) CXVirtualFileOverlay #As("CXVirtualFileOverlay") #Foreign("clang_VirtualFileOverlay_create")
clang_VirtualFileOverlay_addFileMapping(p0 CXVirtualFileOverlay #As("CXVirtualFileOverlay"), virtualPath *sbyte, realPath *sbyte) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_VirtualFileOverlay_addFileMapping")
clang_VirtualFileOverlay_setCaseSensitivity(p0 CXVirtualFileOverlay #As("CXVirtualFileOverlay"), caseSensitive int) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_VirtualFileOverlay_setCaseSensitivity")
clang_VirtualFileOverlay_writeToBuffer(p0 CXVirtualFileOverlay #As("CXVirtualFileOverlay"), options uint, out_buffer_ptr **sbyte, out_buffer_size *uint) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_VirtualFileOverlay_writeToBuffer")
clang_free(buffer pointer) void #Foreign("clang_free")
clang_VirtualFileOverlay_dispose(p0 CXVirtualFileOverlay #As("CXVirtualFileOverlay")) void #Foreign("clang_VirtualFileOverlay_dispose")
CXModuleMapDescriptorImpl struct {
	unused int
}
CXModuleMapDescriptor struct #RefType {
	unused int
}
clang_ModuleMapDescriptor_create(options uint) CXModuleMapDescriptor #As("CXModuleMapDescriptor") #Foreign("clang_ModuleMapDescriptor_create")
clang_ModuleMapDescriptor_setFrameworkModuleName(p0 CXModuleMapDescriptor #As("CXModuleMapDescriptor"), name *sbyte) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_ModuleMapDescriptor_setFrameworkModuleName")
clang_ModuleMapDescriptor_setUmbrellaHeader(p0 CXModuleMapDescriptor #As("CXModuleMapDescriptor"), name *sbyte) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_ModuleMapDescriptor_setUmbrellaHeader")
clang_ModuleMapDescriptor_writeToBuffer(p0 CXModuleMapDescriptor #As("CXModuleMapDescriptor"), options uint, out_buffer_ptr **sbyte, out_buffer_size *uint) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_ModuleMapDescriptor_writeToBuffer")
clang_ModuleMapDescriptor_dispose(p0 CXModuleMapDescriptor #As("CXModuleMapDescriptor")) void #Foreign("clang_ModuleMapDescriptor_dispose")
CXTargetInfoImpl struct {
	unused int
}
CXTargetInfo struct #RefType {
	unused int
}
CXTranslationUnitImpl struct {
	unused int
}
CXTranslationUnit struct #RefType {
	unused int
}
...
clang_isFileMultipleIncludeGuarded(tu CXTranslationUnit #As("CXTranslationUnit"), file pointer) uint #Foreign("clang_isFileMultipleIncludeGuarded")
clang_getFile(tu CXTranslationUnit #As("CXTranslationUnit"), file_name *sbyte) pointer #Foreign("clang_getFile")
clang_getFileContents(tu CXTranslationUnit #As("CXTranslationUnit"), file pointer, size *ulong) *sbyte #Foreign("clang_getFileContents")
...
clang_getLocation(tu CXTranslationUnit #As("CXTranslationUnit"), file pointer, line uint, column uint) CXSourceLocation #As("CXSourceLocation") #Foreign("clang_getLocation")
clang_getLocationForOffset(tu CXTranslationUnit #As("CXTranslationUnit"), file pointer, offset uint) CXSourceLocation #As("CXSourceLocation") #Foreign("clang_getLocationForOffset")
...
clang_getSkippedRanges(tu CXTranslationUnit #As("CXTranslationUnit"), file pointer) *CXSourceRangeList #As("CXSourceRangeList *") #Foreign("clang_getSkippedRanges")
clang_getAllSkippedRanges(tu CXTranslationUnit #As("CXTranslationUnit")) *CXSourceRangeList #As("CXSourceRangeList *") #Foreign("clang_getAllSkippedRanges")
...
clang_getNumDiagnostics(Unit CXTranslationUnit #As("CXTranslationUnit")) uint #Foreign("clang_getNumDiagnostics")
clang_getDiagnostic(Unit CXTranslationUnit #As("CXTranslationUnit"), Index uint) pointer #Foreign("clang_getDiagnostic")
clang_getDiagnosticSetFromTU(Unit CXTranslationUnit #As("CXTranslationUnit")) pointer #Foreign("clang_getDiagnosticSetFromTU")
...
clang_getTranslationUnitSpelling(CTUnit CXTranslationUnit #As("CXTranslationUnit")) CXString #As("CXString") #Foreign("clang_getTranslationUnitSpelling")
clang_createTranslationUnitFromSourceFile(CIdx pointer, source_filename *sbyte, num_clang_command_line_args int, clang_command_line_args **sbyte, num_unsaved_files uint, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *")) CXTranslationUnit #As("CXTranslationUnit") #Foreign("clang_createTranslationUnitFromSourceFile")
clang_createTranslationUnit(CIdx pointer, ast_filename *sbyte) CXTranslationUnit #As("CXTranslationUnit") #Foreign("clang_createTranslationUnit")
clang_createTranslationUnit2(CIdx pointer, ast_filename *sbyte, out_TU *CXTranslationUnit #As("CXTranslationUnit *")) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_createTranslationUnit2")
...
clang_parseTranslationUnit(CIdx pointer, source_filename cstring, command_line_args *cstring, num_command_line_args int, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), num_unsaved_files uint, options uint) CXTranslationUnit #As("CXTranslationUnit") #Foreign("clang_parseTranslationUnit")
clang_parseTranslationUnit2(CIdx pointer, source_filename *sbyte, command_line_args **sbyte, num_command_line_args int, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), num_unsaved_files uint, options uint, out_TU *CXTranslationUnit #As("CXTranslationUnit *")) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_parseTranslationUnit2")
clang_parseTranslationUnit2FullArgv(CIdx pointer, source_filename *sbyte, command_line_args **sbyte, num_command_line_args int, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), num_unsaved_files uint, options uint, out_TU *CXTranslationUnit #As("CXTranslationUnit *")) CXErrorCode #As("enum CXErrorCode") #Foreign("clang_parseTranslationUnit2FullArgv")
:CXSaveTranslationUnit_None int = 0
CXSaveTranslationUnit_Flags enum #Flags {
	CXSaveTranslationUnit_None = 0_u
}
clang_defaultSaveOptions(TU CXTranslationUnit #As("CXTranslationUnit")) uint #Foreign("clang_defaultSaveOptions")
...
clang_saveTranslationUnit(TU CXTranslationUnit #As("CXTranslationUnit"), FileName *sbyte, options uint) int #Foreign("clang_saveTranslationUnit")
clang_suspendTranslationUnit(p0 CXTranslationUnit #As("CXTranslationUnit")) uint #Foreign("clang_suspendTranslationUnit")
clang_disposeTranslationUnit(p0 CXTranslationUnit #As("CXTranslationUnit")) void #Foreign("clang_disposeTranslationUnit")
:CXReparse_None int = 0
CXReparse_Flags enum #Flags {
	CXReparse_None = 0_u
}
clang_defaultReparseOptions(TU CXTranslationUnit #As("CXTranslationUnit")) uint #Foreign("clang_defaultReparseOptions")
clang_reparseTranslationUnit(TU CXTranslationUnit #As("CXTranslationUnit"), num_unsaved_files uint, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), options uint) int #Foreign("clang_reparseTranslationUnit")
...
clang_getCXTUResourceUsage(TU CXTranslationUnit #As("CXTranslationUnit")) CXTUResourceUsage #As("CXTUResourceUsage") #Foreign("clang_getCXTUResourceUsage")
clang_disposeCXTUResourceUsage(usage CXTUResourceUsage #As("CXTUResourceUsage")) void #Foreign("clang_disposeCXTUResourceUsage")
clang_getTranslationUnitTargetInfo(CTUnit CXTranslationUnit #As("CXTranslationUnit")) CXTargetInfo #As("CXTargetInfo") #Foreign("clang_getTranslationUnitTargetInfo")
clang_TargetInfo_dispose(Info CXTargetInfo #As("CXTargetInfo")) void #Foreign("clang_TargetInfo_dispose")
clang_TargetInfo_getTriple(Info CXTargetInfo #As("CXTargetInfo")) CXString #As("CXString") #Foreign("clang_TargetInfo_getTriple")
clang_TargetInfo_getPointerWidth(Info CXTargetInfo #As("CXTargetInfo")) int #Foreign("clang_TargetInfo_getPointerWidth")
...
clang_getTranslationUnitCursor(p0 CXTranslationUnit #As("CXTranslationUnit")) CXCursor #As("CXCursor") #Foreign("clang_getTranslationUnitCursor")
...
clang_Cursor_getTranslationUnit(p0 CXCursor #As("CXCursor")) CXTranslationUnit #As("CXTranslationUnit") #Foreign("clang_Cursor_getTranslationUnit")
CXCursorSetImpl struct {
	unused int
}
CXCursorSet struct #RefType {
	unused int
}
clang_createCXCursorSet() CXCursorSet #As("CXCursorSet") #Foreign("clang_createCXCursorSet")
clang_disposeCXCursorSet(cset CXCursorSet #As("CXCursorSet")) void #Foreign("clang_disposeCXCursorSet")
clang_CXCursorSet_contains(cset CXCursorSet #As("CXCursorSet"), cursor CXCursor #As("CXCursor")) uint #Foreign("clang_CXCursorSet_contains")
clang_CXCursorSet_insert(cset CXCursorSet #As("CXCursorSet"), cursor CXCursor #As("CXCursor")) uint #Foreign("clang_CXCursorSet_insert")
...
clang_getCursor(p0 CXTranslationUnit #As("CXTranslationUnit"), p1 CXSourceLocation #As("CXSourceLocation")) CXCursor #As("CXCursor") #Foreign("clang_getCursor")
...
clang_getModuleForFile(p0 CXTranslationUnit #As("CXTranslationUnit"), p1 pointer) pointer #Foreign("clang_getModuleForFile")
...
clang_Module_getNumTopLevelHeaders(p0 CXTranslationUnit #As("CXTranslationUnit"), Module pointer) uint #Foreign("clang_Module_getNumTopLevelHeaders")
clang_Module_getTopLevelHeader(p0 CXTranslationUnit #As("CXTranslationUnit"), Module pointer, Index uint) pointer #Foreign("clang_Module_getTopLevelHeader")
...
clang_getToken(TU CXTranslationUnit #As("CXTranslationUnit"), Location CXSourceLocation #As("CXSourceLocation")) *CXToken #As("CXToken *") #Foreign("clang_getToken")
clang_getTokenKind(p0 CXToken #As("CXToken")) CXTokenKind #As("CXTokenKind") #Foreign("clang_getTokenKind")
clang_getTokenSpelling(p0 CXTranslationUnit #As("CXTranslationUnit"), p1 CXToken #As("CXToken")) CXString #As("CXString") #Foreign("clang_getTokenSpelling")
clang_getTokenLocation(p0 CXTranslationUnit #As("CXTranslationUnit"), p1 CXToken #As("CXToken")) CXSourceLocation #As("CXSourceLocation") #Foreign("clang_getTokenLocation")
clang_getTokenExtent(p0 CXTranslationUnit #As("CXTranslationUnit"), p1 CXToken #As("CXToken")) CXSourceRange #As("CXSourceRange") #Foreign("clang_getTokenExtent")
clang_tokenize(TU CXTranslationUnit #As("CXTranslationUnit"), Range CXSourceRange #As("CXSourceRange"), Tokens **CXToken #As("CXToken **"), NumTokens *uint) void #Foreign("clang_tokenize")
clang_annotateTokens(TU CXTranslationUnit #As("CXTranslationUnit"), Tokens *CXToken #As("CXToken *"), NumTokens uint, Cursors *CXCursor #As("CXCursor *")) void #Foreign("clang_annotateTokens")
clang_disposeTokens(TU CXTranslationUnit #As("CXTranslationUnit"), Tokens *CXToken #As("CXToken *"), NumTokens uint) void #Foreign("clang_disposeTokens")
...
clang_codeCompleteAt(TU CXTranslationUnit #As("CXTranslationUnit"), complete_filename *sbyte, complete_line uint, complete_column uint, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), num_unsaved_files uint, options uint) *CXCodeCompleteResults #As("CXCodeCompleteResults *") #Foreign("clang_codeCompleteAt")
...
clang_getInclusions(tu CXTranslationUnit #As("CXTranslationUnit"), visitor pointer #As("CXInclusionVisitor"), client_data pointer) void #Foreign("clang_getInclusions")
:CXEval_Int int = 1
:CXEval_Float int = 2
...
clang_findIncludesInFile(TU CXTranslationUnit #As("CXTranslationUnit"), file pointer, visitor CXCursorAndRangeVisitor #As("CXCursorAndRangeVisitor")) CXResult #As("CXResult") #Foreign("clang_findIncludesInFile")
CXIdxLoc struct {
	ptr_data_0 pointer
	ptr_data_1 pointer
	int_data uint
...
clang_indexSourceFile(p0 pointer, client_data pointer, index_callbacks *IndexerCallbacks #As("IndexerCallbacks *"), index_callbacks_size uint, index_options uint, source_filename *sbyte, command_line_args **sbyte, num_command_line_args int, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), num_unsaved_files uint, out_TU *CXTranslationUnit #As("CXTranslationUnit *"), TU_options uint) int #Foreign("clang_indexSourceFile")
clang_indexSourceFileFullArgv(p0 pointer, client_data pointer, index_callbacks *IndexerCallbacks #As("IndexerCallbacks *"), index_callbacks_size uint, index_options uint, source_filename *sbyte, command_line_args **sbyte, num_command_line_args int, unsaved_files *CXUnsavedFile #As("struct CXUnsavedFile *"), num_unsaved_files uint, out_TU *CXTranslationUnit #As("CXTranslationUnit *"), TU_options uint) int #Foreign("clang_indexSourceFileFullArgv")
clang_indexTranslationUnit(p0 pointer, client_data pointer, index_callbacks *IndexerCallbacks #As("IndexerCallbacks *"), index_callbacks_size uint, index_options uint, p5 CXTranslationUnit #As("CXTranslationUnit")) int #Foreign("clang_indexTranslationUnit")
